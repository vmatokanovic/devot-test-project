...
const LoginForm = () => {
  ...
  return (
    <>
      <Toast ref={toast} />
      <form
        className="bg-[#F9F9FD] flex flex-col justify-center gap-2
         h-[370px] border-[0.5px] border-[#ECEDF5] rounded-md
        px-5 mt-[0px]"
        onSubmit={formik.handleSubmit}
      >
        <h1 className="text-[24px] font-[700] text-center mb-5">Login</h1>
        ...
        <Button className="h-[36px] mt-[32px]" type="submit" label="Login" />
      </form>
      <div
